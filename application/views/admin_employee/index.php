...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> ข้าราชการพนักงาน สสจ.มหาสารคาม
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">เพิ่มข้าราชการพนักงาน สสจ.มหาสารคาม</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="hospcode" placeholder="รหัสหน่วยบริการ" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="date_in">วันเริ่มทำงาน</label>
                    <input type="text" class="form-control" id="date_in" placeholder="วันเริ่มทำงาน" value=""></div>
                <div class="form-group">
                    <label for="date_out">วันสิ้นสุดการทำงาน</label>
                    <input type="text" class="form-control" id="date_out" placeholder="วันสิ้นสุดการทำงาน" value="">
                </div>
                <div class="form-group">
