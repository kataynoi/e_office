...
// $pdf->SetFont('freeserif', '', 12);
    ...
    switch  ($pageNo){
        case 1:
            ...
            $pdf->writeHTML("<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".to_thai_number_text($out_site->invit_subject)."</div>");
